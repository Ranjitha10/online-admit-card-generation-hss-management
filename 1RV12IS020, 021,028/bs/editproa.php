...
<form name="form2" method="post" action="aupdate.php" onClick="checkinput"><br>
<table align="center">
<tr>
...
<td height="30">ID<td> : <td height="30"><input type="text" name="id" size="20" style= "text-transform:uppercase" value= <?php echo $_SESSION["aid"] ?> readonly ></tr><tr>
