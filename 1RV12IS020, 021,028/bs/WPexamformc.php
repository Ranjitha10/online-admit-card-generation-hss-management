...
function showinfo(){
	var xmlhttp = new XMLHttpRequest();
		...
		xmlhttp.open('GET','WPexamformcajax.php',true);
		xmlhttp.send();
}
 </script>
   </head>
...
font-size: 16px;"><a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
				  ...
				  <td align="center" width="280px" bgcolor = "cyan"><a  href="WPexamformc.php"><i class="fa fa-edit fa-3x"></i> EXAM REGISTRATION </a></td>
			...
			<h3>Exam Forms</h3>
			<button onclick="showinfo()">Refresh Forms</button>
			<form action="verifyforms.php" method="post">
			<hr/>
			 <table  position="center" id="table"  width="860" border="2px" >
   ...
   <hr />                
                ...
                <hr />
    				...
    				<input type="submit" name="submit" value="Forward Forms" align="center">
        			
					    <input type="submit" name="reject" value="Reject Forms" align="center">
					</form>
                </p>
