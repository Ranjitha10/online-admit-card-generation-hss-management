...
function showinfo(){
	var xmlhttp = new XMLHttpRequest();
		...
		xmlhttp.open('GET','WPhssmngrcajax.php',true);
		xmlhttp.send();
}
 </script>
   </head>
...
font-size: 16px;"><a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
				  ...
				  <td align="center" width="280px" bgcolor = "cyan"><a  href="WPhssmngrc.php"><i class="fa fa-desktop fa-3x"></i> HSS MANAGEMENT</a></td>
			...
			<hr/>
			 <table  position="center" id="table" border="2px"  width="860" >
   ...
   <hr />                
                ...
                <hr />
    				...
    				<input type="submit" name="submit" value="Verify Selected" align="center">
        			</form>
                </p>
