...
font-size: 16px;"><a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
				  ...
				  <tr>
				  <td align="center" width="280px" bgcolor="cyan"><a class="active-menu"  href="WPindexc.php"><i class="fa fa-home fa-4x"></i> Home</a></td>
            ...
            <form action="dsmsg.php" method="post">
   	<input type="submit" value="DELETE MESSAGES" name="submit">
    </form>
                 <!-- /. ROW  -->

               <table width="500" >
            <tr><th>USN</th><th>MESSAGE</th><tr>
			...
			$selected = mysql_select_db("ereges",$dbhandle) 
  			...
  			$a = $_SESSION["cid"];
  			$sql = "SELECT `susn`,`smsg` FROM `smsg` WHERE cid = '$a'";
			
  			
			$ret1 = mysql_query($sql);
				if(!$ret1){echo "error ".$sql; }
			   	while($row = mysql_fetch_assoc($ret1)){
				echo "<td height='30'>".$row['susn']."</td><td>".$row['smsg']."</td><tr>";}
				?>
                    <hr />
                 </div>
