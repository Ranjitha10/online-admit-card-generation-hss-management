        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
				  ...
				  <tr>
				  <td align="center" width="280px" bgcolor="cyan"><a class="active-menu"  href="WPindexa.php"><i class="fa fa-home fa-4x"></i> Home</a></td>
				  
				  <td align="center" width="280px"><a  href="WPexamformad.php"><i class="fa fa-edit fa-3x"></i> EXAM FORMS</a></td>
				  <td align="center" width="280px"><a  href="faaq.html"><i class="fa fa-table fa-3x"></i> FAQ</a></td>
			...
			<table id="table1">
			 ...
			 <div class="text-box" >
			   ...
			   <div class="kk">
						<h3>Total No. of Pending Requests:</h3>
			<table width = "300px" border="2px">
			<tr><th>SEMESTER</th><th>No. Of Registration</th></tr><tr>
			<?php
			$hostname="localhost"; 
			$username="root"; 
			$password="root"; 
			...
			$sql = "SELECT `sem`,COUNT(`susn`) FROM `exam_reg` WHERE averify <> '$g' GROUP BY `sem`";
			$ret1 = mysql_query($sql);
				if(!$ret1){echo "error ".$sql; }
			   	while($row = mysql_fetch_assoc($ret1)){
				echo "<td height='30'>".$row['sem']."</td><td>".$row['COUNT(`susn`)']."</td></tr><tr>";}
				?>
			   </div>
               </div>       
                 <!-- /. ROW  -->           
