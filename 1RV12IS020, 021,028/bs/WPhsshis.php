...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
	...
	var xmlhttp = new XMLHttpRequest();
		...
		xmlhttp.open('GET','WPhsshisajax.php',true);
		xmlhttp.send();
}
function editinfo(){
	var xmlhttp = new XMLHttpRequest();
...
font-size: 16px;"><a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <!-- /. NAV SIDE  -->
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                     <a href="WPhsshis.php"><p class="main-text"><b><i><mark>HSS</p></a>
                    <p class="text-muted">History</p></mark></i></b>
                </div>
             </div>
		     </div>
             <div class="col-md-3 col-sm-6 col-xs-6">           
			...
			<button onclick="showinfo()">Check HSS</button>
			
            <tr><th>EVENT NAME</th><th>POSITION</th><th>GRADE</th></tr>
            <tr>
