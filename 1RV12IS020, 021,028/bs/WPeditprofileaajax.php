...
echo '<td height="30">ID<td> : <td height="30"><input type="text" name="id" size="20" style= "text-transform:uppercase" value='.$_SESSION["aid"].'></tr><tr>';
